...
const SKIP = new Set(['node_modules', '.next', 'out', 'dist', '.git', 'schema', 'docs', 'mods']);

/** Generated by tooling, and not ours to place in a project. */
const GENERATED = new Set(['apps/editor/next-env.d.ts', 'apps/play/next-env.d.ts', 'apps/site/next-env.d.ts']);
